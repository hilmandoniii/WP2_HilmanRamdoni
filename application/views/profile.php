...
<html lang="en" class="scroll-smooth">
  <head>
    ...
    <title>Hilman Ramdoni | Portofolio</title>
    <link href="<?= base_url() ?>assets/dist/css/final.css" rel="stylesheet" />
    <script>
  ...
  <body>
    ...
    <header class="absolute top-0 left-0 z-10 flex w-full items-center bg-transparent">
      <div class="container">
        <div class="relative flex items-center justify-between">
          <div class="px-4">
            <a href="#home" class="block py-6 text-lg font-bold text-primary">My Portofolio</a>
          </div>
    ...
    <!-- Hero Section Start -->
    <section id="home" class="pt-10 dark:bg-dark">
      <div class="container">
        <div class="flex flex-wrap">
          <div class="w-full self-center px-4 lg:w-1/2">
            <h1 class="text-base font-semibold text-primary md:text-xl">👋 Hello! I'am <span class="mt-1 block text-4xl font-bold text-dark dark:text-white lg:text-5xl">Hilman Ramdoni</span></h1><br>
            <p class="mb-10 font-medium leading-relaxed text-secondary">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati, nihil sed! Fugiat quia numquam repellat atque debitis. Fuga, quidem dolorem. <span class="font-bold text-dark dark:text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem, facere?. </span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus vitae similique dolorum inventore odit modi.</p>
          ...
          <div class="w-full self-end px-4 lg:w-1/2">
            <div class="relative mt-10 lg:right-0 lg:mt-9">
              <img src="<?= base_url() ?>assets/dist/img/profile.jpg" alt="Hilman Ramdoni" class="relative z-10 mx-auto max-w-full" style="width: 70%; border-radius: 20%;" />
        ...
        <div class="container">
          <div class="w-full border-t border-slate-700 pt-10">
            ...
            <p class="text-center text-xs font-medium text-slate-500">
              Made with <span class="text-pink-500">❤️</span> by <a href="#" target="_blank" class="font-bold text-primary">Hilman Ramdoni</a>, using
